...
function Hero() {
  return (
    <div className="container" style={{ fontFamily: "Inter,sans-serif", color: "#424242",padding: "80px 0px"}}>
      ...
      <div className="row border-top text-decoration-none" style={{ margin: "0px 185.2px",fontSize:"16px" }}> 
            <div className="col-6 mt-5" style={{ lineHeight: "1.8", margin: "16px 0px 15px" }}> 
